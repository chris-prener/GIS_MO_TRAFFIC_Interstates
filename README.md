# GIS_MO_TRAFFIC_Interstates
This repository contains files that constitute an ESRI shapefile depicting all interstate highways within the State of Missouri. This shapefile was created from the December, 2015 Missouri Department of Transportation data release, which is available from the [Missouri Spatial Data Information Service](http://www.msdis.missouri.edu).
